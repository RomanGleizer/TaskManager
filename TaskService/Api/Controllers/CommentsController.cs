...
public class CommentsController(IDtoService<CommentDTO, int> commentService) : ControllerBase
{
    ...
    public async Task<IActionResult> CreateCommentAsync([FromBody] CreateCommentDTO request)
    {
    ...
    public async Task<IActionResult> UpdateCommentAsync([FromBody] CreateCommentDTO request, [FromRoute] int commentId)
    {
